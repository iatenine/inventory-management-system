...
const Login = () => {
  ...
  return (
    <div className="ui center aligned container">
      { data ? (
        <h2>You are already logged in! You may now head{' '}
        <Link to="/" >back to the homepage.</Link></h2>
      ): (
        <div>
      <h2>Login Below</h2>
      ...
      <form className="ui form" onSubmit={handleFormSubmit}>
        ...
        <div className="field">
          ...
          <input type="text" name="password" placeholder="Password" value={formState.password} onChange={handleChange}></input>
        </div>
